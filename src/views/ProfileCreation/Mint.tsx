...
import { Card, CardBody, Heading, Text } from '@trading-planet/uikit'
...
const Mint: React.FC = () => {
  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {t('You can change your profile pic later if you get another approved TradingPlanet Collectible.')}
      </Text>
      <Card mb="24px">
        <CardBody>
