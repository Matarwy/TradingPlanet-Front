...
import { Heading, Button, Text } from '@trading-planet/uikit'
  ...
  return (
    <>
      ...
      <Text color="textSubtle">
        {t('It looks like you’ve disabled your account by removing your TradingPlanet Collectible (NFT) profile picture.')}
      </Text>
      <Text>
